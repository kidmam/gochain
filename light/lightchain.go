...
func (lc *LightChain) loadLastState() error {
	if head := rawdb.ReadHeadHeaderHash(lc.chainDb.GlobalTable()); head == (common.Hash{}) {
...
func (lc *LightChain) ResetWithGenesisBlock(genesis *types.Block) {
	...
	rawdb.WriteTd(lc.chainDb.GlobalTable(), genesis.Hash(), genesis.NumberU64(), genesis.Difficulty())
