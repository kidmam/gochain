...
import (
	...
	"github.com/gochain-io/gochain/v3/signer/rules"
...
func signer(c *cli.Context) error {
	...
	if c.GlobalBool(utils.RPCEnabledFlag.Name) {
		...
		listener, _, err := rpc.StartHTTPEndpoint(httpEndpoint, rpcAPI, []string{"account"}, cors, vhosts, rpc.DefaultHTTPTimeouts, false)
		if err != nil {
